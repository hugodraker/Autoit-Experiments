...
; ============================
; SECTION 1: FAST NATIVE ZLIB
; ============================

; TODO: replace this stub with your fast native zlib/deflate UDF.
Func _ZLIB_Inflate($bData)
    ; $bData is Binary() with raw deflate/zlib data
    ; RETURN: Binary() of decompressed data, or SetError(1) on failure
