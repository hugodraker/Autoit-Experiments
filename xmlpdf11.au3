...
Func Example_Main()
    Local $hGUI = GUICreate("XML → PDF Generator (Images + Text + CSS Tables + Compression + WMF Vector + WEBP)", 900, 600)
...
Func _HandleCreatePDF()
    ...
    Local $sOutPDF = $g_sXMLDir & "\output_css_tables_wmf_vector_webp.pdf"
...
; ============================================================
; MAIN PDF ENGINE (TEXT + CSS TABLE + IMAGE/WMF VECTOR + WEBP)
; ============================================================
Func _PDF_CreateMultiImageWithTextAndTablesCSS($sOutputPDF, ByRef $aImages, ByRef $aTexts, ByRef $aTablesPerPage, $iPageW, $iPageH, $iCompPercent)
    ...
    For $i = 0 To $iCount - 1
        ...
        Local $bIsWEBP = (StringLower(StringRight($sImgPath, 5)) = ".webp")
